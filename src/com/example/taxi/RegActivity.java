...
public class RegActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCompare = (Button) findViewById(R.id.btn_confirm);
        ...
        ConfMes = (TextView) findViewById(R.id.cnf_message);
        ConfMes.setVisibility(View.INVISIBLE);
                ...
                switch (v.getId()) {
                    ...
                    case R.id.btn_continue:
                        ...
                        if (phoneNo.length() > 7) {
                            ...
                            PhoneMes.setVisibility(View.INVISIBLE);
                            btnCompare.setVisibility(View.VISIBLE);
                            ConfMes.setVisibility(View.VISIBLE);
                            txtPhoneNo.setText("");
